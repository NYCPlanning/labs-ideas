# Ideas
A React app that displays ideas and projects for planninglabs.nyc.

## Dependencies
This makes requests to the Airtable proxy API: https://github.com/NYCPlanning/labs-ideas-api.
